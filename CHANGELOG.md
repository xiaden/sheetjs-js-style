...
-   XLSX worksheet writer support for serializing `ws['!freeze']` as `<pane .../>` in sheet views

### Changed

-   Added validation guard for `ws['!freeze']` to enforce a single freeze definition per sheet
